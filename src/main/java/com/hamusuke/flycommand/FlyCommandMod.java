...
public class FlyCommandMod {
	...
	static final class ModItems {
		private static final DeferredRegister<Item> ITEMS = DeferredRegister.create(ForgeRegistries.ITEMS, FlyCommandMod.MOD_ID);
		public static final RegistryObject<FlyingStickItem> FLYING_STICK_ITEM = ITEMS.register("flying_stick", () -> new FlyingStickItem(new Item.Properties().tab(CreativeModeTab.TAB_TOOLS).stacksTo(1)));
